  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      if (
        ...
        setError("Missing or invalid booking details. Please try booking again.");
        setIsLoading(false);
        return;
      }
      ...
      <div className="booking-confirmation-wrapper">
        ...
        <main className="booking-confirmation-main">
          <div className="error-message" aria-live="polite">
            <h2>Error</h2>
            <p>{error || "Failed to load booking details. Please try again."}</p>
            <a href="/booking">
    ...
    <div className="booking-confirmation-wrapper">
      ...
      <main className="booking-confirmation-main">
        <div className="success-message" aria-live="polite">
          ...
          <p>
            Confirmation{Object.keys(bookedByUsers).length > 1 ? "s have" : " has"} been sent to the registered email
            {Object.keys(bookedByUsers).length > 1 ? "s" : ""}. Please bring a valid ID to the event.
          </p>
        </div>
        ...
        <div className="action-section">
          <a href={`/seat-layout?eventId=${selectedEvent}`}>
            <button aria-label="Book another ticket">Book another ticket</button>
          </a>
        </div>
      </main>
    </div>
